 ...
 */
contract ScarabVaultv1_3 is ERC20, Ownable, ReentrancyGuard {
    ...
    */
     ...
     * Never invest in a Scarab Vault with tokens you don't trust.
     * Never invest in a Scarab Vault with tokens whose rules for minting you don’t agree with.
     * Ensure the accuracy of the contracts for the tokens in the Scarab Vault.
     * Ensure the accuracy of the contracts for the Scarab Vault and Strategy you are depositing in.
